...
if (isset($request_data['full_name']) && isset($request_data['age']) && isset($request_data['gender']) && isset($request_data['mobile_number']) && isset($request_data['email']) && isset($request_data['password']) ) {
    ...
    if (isset($request_data['register']) && $request_data['register'] === true) {
        // Registration
        $sql = "INSERT INTO users (full_name, age, gender,  mobile_number, email, password) VALUES (:username, :password)";
